...
from notslowapi.openapi.models import HTTPBase as HTTPBaseModel
from notslowapi.openapi.models import HTTPBearer as HTTPBearerModel
...
class HTTPDigest(HTTPBase):
    ...
    **Warning**: this is only a stub to connect the components with OpenAPI in FastAPI,
    ...
    from notslowapi import Depends, FastAPI
    from notslowapi.security import HTTPAuthorizationCredentials, HTTPDigest
