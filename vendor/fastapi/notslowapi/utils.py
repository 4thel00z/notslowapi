...
from notslowapi.datastructures import DefaultPlaceholder, DefaultType
from notslowapi.exceptions import FastAPIDeprecationWarning, PydanticV1NotSupportedError
...
def create_model_field(
    ...
    try:
        ...
        raise notslowapi.exceptions.FastAPIError(
...
def generate_operation_id_for_path(
    *, name: str, path: str, method: str
    ...
    warnings.warn(
        message="notslowapi.utils.generate_operation_id_for_path() was deprecated, "
