...
from notslowapi.datastructures import DefaultPlaceholder, _Unset
...
from notslowapi.openapi.constants import METHODS_WITH_BODY, REF_PREFIX
from notslowapi.openapi.models import OpenAPI
from notslowapi.params import Body, ParamTypes
from notslowapi.responses import Response
from notslowapi.sse import _SSE_EVENT_SCHEMA
from notslowapi.starlette.responses import JSONResponse
from notslowapi.starlette.routing import BaseRoute
from notslowapi.types import DependencyCacheKey, ModelNameMap
...
def generate_operation_id(
    *, route: routing._APIRouteLike, method: str
    ...
    warnings.warn(
        message="notslowapi.openapi.utils.generate_operation_id() was deprecated, "
