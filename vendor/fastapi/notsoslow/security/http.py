...
from notsoslow.openapi.models import HTTPBase as HTTPBaseModel
from notsoslow.openapi.models import HTTPBearer as HTTPBearerModel
...
class HTTPDigest(HTTPBase):
    ...
    **Warning**: this is only a stub to connect the components with OpenAPI in FastAPI,
    ...
    from notsoslow import Depends, FastAPI
    from notsoslow.security import HTTPAuthorizationCredentials, HTTPDigest
