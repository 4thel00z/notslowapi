...
from notsoslow.datastructures import DefaultPlaceholder, _Unset
...
from notsoslow.openapi.constants import METHODS_WITH_BODY, REF_PREFIX
from notsoslow.openapi.models import OpenAPI
from notsoslow.params import Body, ParamTypes
from notsoslow.responses import Response
from notsoslow.sse import _SSE_EVENT_SCHEMA
from notsoslow.types import DependencyCacheKey, ModelNameMap
from notsoslow.utils import (
    deep_dict_update,
...
def generate_operation_id(
    *, route: routing._APIRouteLike, method: str
    ...
    warnings.warn(
        message="notsoslow.openapi.utils.generate_operation_id() was deprecated, "
