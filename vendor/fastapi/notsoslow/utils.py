...
from notsoslow.datastructures import DefaultPlaceholder, DefaultType
from notsoslow.exceptions import FastAPIDeprecationWarning, PydanticV1NotSupportedError
...
def create_model_field(
    ...
    try:
        ...
        raise notsoslow.exceptions.FastAPIError(
...
def generate_operation_id_for_path(
    *, name: str, path: str, method: str
    ...
    warnings.warn(
        message="notsoslow.utils.generate_operation_id_for_path() was deprecated, "
