...
from notslowapi.starlette.routing import Route, Router, WebSocketRoute
from notslowapi.starlette.testclient import TestClient
from notslowapi.starlette.types import Receive, Scope, Send
...
def test_http_exception_does_not_use_threadpool(client: TestClient, monkeypatch: MonkeyPatch) -> None:
    ...
    """
    from notslowapi.starlette import _exception_handler
